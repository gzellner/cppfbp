...
int thzpop(Process *proc, void **ptr, long *size, std::string &typep);
...
int thz(int code, Process *proc, ...)
{
  ...
  if (code < 10 && proc -> trace && value > 0)
    printf("%s: Service retcode %d\n",
	   proc -> procname.c_str(), value);
